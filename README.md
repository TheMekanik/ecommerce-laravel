<p align="center"><a href="https://laravel.com" target="_blank"><img src="storage/app/public/ProductPage.jpeg" width="700"></a></p>
...
- **Admin**
  - **Delete Product**
    <p align="center"><img src="storage/app/public/ProductAdminPage.jpeg"></p>
    <p>The admin can delete products that have been added to the product page. Additionally, the admin can view the details of the displayed products.</p>
  - **Add Product**
    <p align="center"><img src="storage/app/public/CreateProductPage.jpeg"></p>
    <p>The admin can add new products to the product page by inputting several details such as the product name, product description, product stock, product price, and product image.</p>
